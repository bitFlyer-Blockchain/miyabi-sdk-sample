...
namespace Utility
{
    ...
    public class Utils
    {
        ...
        /// <summary>
        /// Test user0 keystore path.
        /// </summary>
        public static string User0KeystorePath => Path.Combine(
        ...
        /// <summary>
        /// Test user1 keystore path.
        /// </summary>
        public static string User1KeystorePath => Path.Combine(
            AppDomain.CurrentDomain.BaseDirectory,
            "Resources",
            "TestKeystores",
            "test-user1.p12");
        ...
        public static KeyPair GetUser0KeyPair() =>
            GetKeyPairFromKeystore(User0KeystorePath);
        ...
        public static KeyPair GetUser1KeyPair() =>
            GetKeyPairFromKeystore(User1KeystorePath);

        /// <summary>
        /// Generates a collection of key pairs.
        /// </summary>
        /// <returns> list of key pairs.</returns>
        public static KeyPair[] GetKeyPairs(int numOfKeyPairs)
        {
            var keyPairs = new KeyPair[numOfKeyPairs];

            for (var i = 0; i < numOfKeyPairs; i++)
            {
                keyPairs[i] = KeyOperations.GenerateKeyPair();
            }
            ...
            string passwordFilePath = null)
        {
            ...
            var password = passwordFilePath == null
                ? null
                : CertParser.ParsePasswordFile(passwordFilePath);

            var privateKey = CertParser.ParseCertFile(keyStorePath, password);
            return new KeyPair(privateKey);
        }

        public static void GetConsoleBanner(
            char wrapCharacter = '=',
            string bannerMessage = "")
        {
            int repetitions = 15;
            string wrapper = new string(wrapCharacter, repetitions);
            Console.WriteLine($"\n{wrapper}{bannerMessage}{wrapper}\n");
        }
    }
}
